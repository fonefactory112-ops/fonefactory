...
export default function ServiceCategories() {
  ...
  const loadCategories = async () => {
    setLoading(true);
    try {
      const data = await api.getServiceCategories(false);
      setCategories(data || []);
    } catch (err) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (editingCategory) {
        await api.updateServiceCategory(editingCategory.id, payload);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await api.deleteServiceCategory(catToDelete.id);
    ...
    <div className="service-mgmt-container">
      <div className="mgmt-header">
        <div>
          ...
          <p>Add, edit, reorder, and deactivate problem categories for customer device repair</p>
        </div>
        ...
        <div className="modal-backdrop">
          <div className="modal-content glass-card shadow-xl">
            <div className="modal-header">
              <h3>{editingCategory ? 'Edit Category' : 'Add Service Category'}</h3>
            ...
            <form onSubmit={handleFormSubmit} className="modal-body">
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="e.g. Display Problem"
                  required
                />
              </div>
      ...
      <ConfirmDialog
        ...
        message={`Are you sure you want to deactivate "${catToDelete?.name}"? Deactivating it will also automatically deactivate all active services linked to this category to prevent display errors.`}
